...

{
    ...
    Scanner sc = new Scanner(System.in); // 0(1)
        ...
        System.out.print("Input jumlah elemen yang ingin dihitung : ");// 0(1)
        ...
        
        {
            ...
            System.out.print("Input nilai data ke-" + (i+1) +" : "); // 0(1)
        ...
        
        {
            ...
            System.out.println("Faktorial dari nilai " + fk[i].nilai + "adalah : "
                    + fk[i].faktorialBF(fk[i].nilai)); // 0(1)
            ...
            
        {
            ...
            System.out.println("Faktorial dari nilai " + fk[i].nilai + "adalah : "
                    + fk[i].faktorialDC(fk[i].nilai)); // 0(1)
        }
