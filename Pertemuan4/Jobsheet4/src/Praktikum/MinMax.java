...
public class MinMax {
    ...
    public static void max_min(int[] arr, int indeks_awal,
            int indeks_akhir, Maxmin hasil)
    ...
    { 
        ...
        { 
            ...
            hasil.minimum = (hasil1.minimum < hasil2.minimum)
                    ? hasil1.minimum : hasil2.minimum; // O(1)
            
            hasil.maximum = (hasil1.maximum > hasil2.maximum)
                    ? hasil1.maximum : hasil2.maximum; // O(1)
